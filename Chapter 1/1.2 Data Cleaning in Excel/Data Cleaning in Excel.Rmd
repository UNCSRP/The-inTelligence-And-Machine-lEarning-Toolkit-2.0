...
++ Note that this only works if there are no cells with missing information or gaps in the columns/rows used to define the peripheral area.
...
+ Create a new tab (preferably as the first tab) and label it “XXXXX_METADATA” (i.e., “Allostatic_METADATA")
+ Then relabel the original data tab as “XXXX_DATA” (i.e., “Allostatic_DATA). 
