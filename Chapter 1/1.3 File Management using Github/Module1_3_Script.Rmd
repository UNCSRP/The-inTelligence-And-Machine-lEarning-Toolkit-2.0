...
Good data practices like file management and code tracking are imperative for data analysis initiatives, especially when working in research teams and/or shared project folders. Often times analyses and manuscripts are edited many times prior to being submitted for a grant or publication. Analysis methods are also shared between members of a research team and to external communities, as further detailed in [TAME 2.0 Module 1.1 FAIR Data Management Practices](INSERT LINK). Therefore, Github has emerged as an effective way to manage, share, and track how code changes over time. 
...
knitr::include_graphics("Module1_3_Images/Module1_3_Image10.png")
```
...
```{r, echo=FALSE, fig.width=4, fig.height=5, fig.align='center'}
knitr::include_graphics("Module1_3_Images/Module1_3_Image11.png")
```

To create a new repository, click on the green button that says "New".
```{r, echo=FALSE, fig.width=4, fig.height=5, fig.align='center'}
knitr::include_graphics("Module1_3_Images/Module1_3_Image12.png")
```
...
knitr::include_graphics("Module1_3_Images/Module1_3_Image13.png")
```
...
```{r, echo=FALSE, fig.width=4, fig.height=5, fig.align='center'}
knitr::include_graphics("Module1_3_Images/Module1_3_Image1.png")
```
...
```{r, echo=FALSE, fig.width=4, fig.height=5, fig.align='center'}
knitr::include_graphics("Module1_3_Images/Module1_3_Image2.png")
```
...
```{r, echo=FALSE, fig.width=4, fig.height=5, fig.align='center'}
knitr::include_graphics("Module1_3_Images/Module1_3_Image3.png")
```
...
```{r, echo=FALSE, fig.width=4, fig.height=5, fig.align='center'}
knitr::include_graphics("Module1_3_Images/Module1_3_Image4.png")
```
...
knitr::include_graphics("Module1_3_Images/Module1_3_Image5.png")
```
...
```{r, echo=FALSE, fig.width=4, fig.height=5, fig.align='center'}
knitr::include_graphics("Module1_3_Images/Module1_3_Image6.png")
```

Name your file “README.md”. 
```{r, echo=FALSE, fig.width=6, fig.height=7, fig.align='center'}
knitr::include_graphics("Module1_3_Images/Module1_3_Image7.png")
```
...
```{r, echo=FALSE, fig.width=4, fig.height=5, fig.align='center'}
knitr::include_graphics("Module1_3_Images/Module1_3_Image8.png")
```
...
```{r, echo=FALSE, fig.width=4, fig.height=5, fig.align='center'}
knitr::include_graphics("Module1_3_Images/Module1_3_Image9.png")
```
...
```{r, echo=FALSE, fig.width=4, fig.height=5, fig.align='center'}
knitr::include_graphics("Module1_3_Images/Module1_3_Image14.png")
```
...
```{r, echo=FALSE, fig.width=4, fig.height=5, fig.align='center'}
knitr::include_graphics("Module1_3_Images/Module1_3_Image15.png")
```
...
```{r, echo=FALSE, fig.width=4, fig.height=5, fig.align='center'}
knitr::include_graphics("Module1_3_Images/Module1_3_Image16.png")
```
...
```{r, echo=FALSE, fig.width=4, fig.height=5, fig.align='center'}
knitr::include_graphics("Module1_3_Images/Module1_3_Image17.png")
```
...
```{r, echo=FALSE, fig.width=2, fig.height=3, fig.align='center'}
knitr::include_graphics("Module1_3_Images/Module1_3_Image18.png")
```
...
```{r, echo=FALSE, fig.width=2, fig.height=3, fig.align='center'}
knitr::include_graphics("Module1_3_Images/Module1_3_Image19.png")
```
