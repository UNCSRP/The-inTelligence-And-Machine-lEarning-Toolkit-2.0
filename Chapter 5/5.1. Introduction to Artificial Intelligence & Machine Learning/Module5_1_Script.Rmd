...
Below is a high level taxonomy of AI. It's not meant to be an exhaustive depiction of all AI techniques, but a simple visualization of how some of these methodologies are nested within each other. Note, that AI can be categorized in different ways and may deviate from what is below.
...
+ Additional discussion on the utility of ML approaches for high-dimensional data in [Payton et. al](https://www.frontiersin.org/articles/10.3389/ftox.2023.1171175/full)
...
```{r out.width = "800px", echo = FALSE, fig.cap= "Created with *Biorender.com*", fig.align = 'center'}
...
+ Perryman AN, Kim H-YH, Payton A, Rager JE, McNell EE, Rebuli ME, et al. (2023) Plasma sterols and vitamin D are correlates and predictors of ozone-induced inflammation in the lung: A pilot study. PLoS ONE 18(5): e0285721. PMID: [37186612](https://journals.plos.org/plosone/article?id=10.1371/journal.pone.0285721)
