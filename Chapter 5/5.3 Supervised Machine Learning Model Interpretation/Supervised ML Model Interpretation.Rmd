...
```{r}
# Load the data
arsenic_data <- data.frame(read_excel("Module5_3TYKInput.xlsx"))
...
### Test Your Knowledge
1. Using the "Module5_3TYKInput.xlsx", extract the variable importance for each predictor on a RF model. What two features have the highest variable importance?  
