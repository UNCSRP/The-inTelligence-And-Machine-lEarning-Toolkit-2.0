...
# exporting figure
ggsave(Module3_3_TYK_figure, 
       filename = 'Module3_3_TYK_figure.png',
       path = Output,
       width = 16, height = 4)
```