...
<thead>
	<tr><th></th><th scope=col>Chemical.Category</th><th scope=col>Chemical</th><th scope=col>CASRN</th><th scope=col>Eucalyptus_Smoldering</th><th scope=col>Eucalyptus_Flaming</th><th scope=col>Peat_Smoldering</th><th scope=col>Peat_Flaming</th><th scope=col>Pine_Smoldering</th><th scope=col>Pine_Flaming</th><th scope=col>Pine_Needles_Smoldering</th><th scope=col>Pine_Needles_Flaming</th><th scope=col>Red_Oak_Smoldering</th><th scope=col>Red_Oak_Flaming</th><th scope=col>Units</th></tr>
...
<tbody>
	<tr><th scope=row>1</th><td>n-Alkanes</td><td>2-Methylnonadecane</td><td>1560-86-7</td><td>0.06</td><td>0.06</td><td>1.36</td><td>0.06</td><td>0.06</td><td>0.06</td><td>0.06</td><td>0.06</td><td>0.06</td><td>0.13</td><td>ng_per_uL</td></tr>
	<tr><th scope=row>2</th><td>n-Alkanes</td><td>3-Methylnonadecane</td><td>6418-45-7</td><td>0.04</td><td>0.04</td><td>1.13</td><td>0.90</td><td>0.47</td><td>0.04</td><td>0.04</td><td>0.72</td><td>0.04</td><td>0.77</td><td>ng_per_uL</td></tr>
	<tr><th scope=row>3</th><td>n-Alkanes</td><td>Docosane          </td><td>629-97-0 </td><td>0.21</td><td>0.25</td><td>9.46</td><td>0.57</td><td>0.16</td><td>0.48</td><td>0.32</td><td>0.18</td><td>0.16</td><td>0.36</td><td>ng_per_uL</td></tr>
	<tr><th scope=row>4</th><td>n-Alkanes</td><td>Dodecylcyclohexane</td><td>1795-17-1</td><td>0.04</td><td>0.04</td><td>0.25</td><td>0.04</td><td>0.04</td><td>0.04</td><td>0.12</td><td>0.04</td><td>0.04</td><td>0.04</td><td>ng_per_uL</td></tr>
	<tr><th scope=row>5</th><td>n-Alkanes</td><td>Eicosane          </td><td>112-95-8 </td><td>0.11</td><td>0.25</td><td>7.55</td><td>0.54</td><td>0.17</td><td>0.29</td><td>0.28</td><td>0.16</td><td>0.15</td><td>0.38</td><td>ng_per_uL</td></tr>
	<tr><th scope=row>6</th><td>n-Alkanes</td><td>Heneicosane       </td><td>629-94-7 </td><td>0.13</td><td>0.28</td><td>6.77</td><td>0.34</td><td>0.13</td><td>0.42</td><td>0.30</td><td>0.13</td><td>0.13</td><td>0.69</td><td>ng_per_uL</td></tr>
</tbody>
</table>
...
ggplot(data = heatmap_df, aes(x = Chemical.Category, y = Biomass_Burn_Condition,
  ...
  geom_tile() + 
  geom_text(aes(label = round(Avg_Scaled_Concentration, 2)))
```
...
Additional parameters, including `cluster_rows`, for `pheatmap` are discussed further in [TAME 2.0 Module 5.4](insert link). For basic heat maps like the ones shown here, `ggplot` or `pheatmap` can both be used however, both have their pros and cons. For example, `ggplot` figures tend to be more customizable and easily combined with figures, while `pheatmap` has additional parameters built into the function that can make plotting certain features advantageous like clustering.
