# Data Visualizations - Test Your Knowledge Solution
...
Before separating biomass and burn condition, we can rename some of the biomass burn conditions, which will then allow us to use the `separate()` function. For example, in the dataframe we have the class `Red_Oak_Smoldering`. In the code below, that will be changed to `Red Oak_Smoldering`. 
...
## Heat Map
```{r fig.align = "center", echo = FALSE,fig.width = 16, fig.height= 4}
